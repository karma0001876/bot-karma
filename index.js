...
console.log(exists);
conn.sendMessage(id ,`Haii, kak 馃憢

*command perintah : !*

鈺斺晲 銆� 鈾KARMA BOT鈾� 銆欌晲鈺愨晽
鈺氣晲鈺愨晲鈺愨晲鈺愨晲鈺愨晲鈺愨晲鈺愨晲鈺愨晲鈺愨晲鈺愨晲鈺愨暆 
鈺� 鈺愩�� 隃吧礇岽準�岽� 岽�薀薀 岽滉湵岽囀� 銆欌晲鈺�
馃尮 *!nulis* [ masukan teks ]
馃尮 *!sticker*
馃尮 *!bhsjepang*
馃尮 *!katabijak*
馃尮 *!fakta*
馃尮 *!pantun*
馃尮 *!pantuncinta*
鈺� 鈺愨晲鈺愨晲鈺愨晲鈺愨晲鈺愨晲鈺愨晲鈺愨暆
鈺� 鈺愩�� 蕗岽囀熒⑸磸岽滉湵 岽勧磸岽嶀磵岽�纱岽� 銆欌晽
馃尮 *!quran* 
馃尮 *!sholat* [ nama daerah ]
鈺� 鈺愨晲鈺愨晲鈺愨晲鈺愨晲鈺愨晲鈺愨晲鈺愨暆
鈺� 鈺愩�� 岽勧磸岽嶀磵岽�纱岽� 瑟纱隃搬磸蕗岽嶀磤岽浬磸纱 銆欌晽
馃尮 *!ss*
馃尮 *!wiki* 
馃尮 *!brainly*
馃尮 *!svc* [ tag orng ny ]
...
馃尮 *!zodiak* 
馃尮 *!listzodiak*
鈺氣晲鈺愨晲鈺愨晲鈺愨晲鈺愨晲鈺愨晲鈺愨晲鈺�
鈺斻�� 岽嚿瘁礇岽囀�岽涐磤瑟纱岽嶀磭纱岽� 覔岽囜磤岽涐礈蕗岽囜搐 銆欌晽
馃尮 *!quotes*
馃尮 *!quotesnime*
馃尮 *!nama*
馃尮 *!pasangan* [ nama pasangan l]
馃尮 *!lirik* [ nama lagu ]
馃尮 *!infoig* [ nama ig ]
馃尮 *!gay* [ tag orng ny ]
馃尮 *!buaya* [ tag orng ny ] 
馃尮 *!bmkg*
鈺氣晲鈺愨晲鈺愨晲鈺愨晲鈺愨晲鈺愨晲鈺愨晲鈺�
鈺斺晲銆� 岽呩磸岽∩词熱磸岽�岽呩磭蕗 岽勧磸岽嶀磵岽�纱岽呹湵 銆欌晽
馃尮 *!ytmp3* [ link ]
馃尮 *!ytmp4* [ link ]
馃尮 *!instagram* [ link ]
馃尮 *!twt* [ link ]
...
馃尮 *!animeimg*
鈺� 鈺愨晲鈺愨晲鈺愨晲鈺愨晲鈺愨晲鈺愨晲鈺愨暆
鈺斺晲銆� 岽忈礇蕼岽囀�岽� 岽勧磸岽嶀磵岽�纱岽呩搐 銆欌晲鈺�
馃尮 *!say*
馃尮 *!tts*
馃尮 *!covidindo*
鈺氣晲鈺愨晲鈺愨晲鈺愨晲鈺愨晲鈺愨晲鈺愨晲鈺�
鈺斺晲銆� 岽�蕶岽忈礈岽� 蕶岽忈礇 銆欌晽
馃尮 *!join*
馃尮 *!donasi*
馃尮 *!ownerbot*
馃尮 *!linkgroup*
鈺氣晲鈺愨晲鈺愨晲鈺愨晲鈺愨晲鈺愨晲鈺愨晲鈺�
鈺斺晲銆� 岽忈础纱岽囀� 蕶岽忈礇 銆欌晲鈺�
馃尮 *!ban* - banned
馃尮 *!bc* - promosi
馃尮 *!leaveall* - keluar semua grup
馃尮 *!clearall* - hapus semua chat
馃尮 *!offbot* - mematikan bot
馃尮 *!onbot* - menyalahkan bot
馃尮 *!ressetbot* - resset system bot
鈺氣晲鈺愨晲鈺愨晲鈺愨晲鈺愨晲鈺愨晲鈺愨晲鈺�

${gg} ${exists ? " exists " : "*Thank for Using REIN-BOT* 馃挄"}
...
馃尮 *!onbot* - menyalahkan bot
馃尮 *!ressetbot* - resset system bot
馃尮 *!replay enable* - Pesan Replay
馃尮 *!replay disable* - Peaan Replay
鈺氣晲鈺愨晲鈺愨晲鈺愨晲鈺愨晲鈺愨晲鈺愨晲鈺�
${gg} ${exists ? " exists " : "*Thank for Using REIN-BOT* 馃挄"}
_#tetap jaga kesehatan_ ^_^`, MessageType.text)
...
const exists = await conn.isOnWhatsApp (gg)
console.log(exists);
conn.sendMessage(id ,`鈺� 鈺愩�� *鈾� 锔廟EIN-BOT鈾� 锔�* 銆欌晽

*BAKAA!!* Bot tidak dapat join harus di lakukan secara manual/meminta kepada owner bot

${gg} ${exists ? " exists " : "*[ REIN-BOT ]* 馃挄"}`, MessageType.text)
}
...
const exists = await conn.isOnWhatsApp (gg)
console.log(exists);
conn.sendMessage(id ,`鈺� 鈺愩�� *鈾ワ笍NHENTAI 鈾�* 銆欌晽
CODE NUKLIR 
192704 NTR bathroom
313777 NTR senpai
314237 incets
...
鈥229144 253687 238577 236509
鈥227675 229085 233245 266177
...
鈥225496 259137 231681 161688
鈥199613 259260 260433 235532 
鈥88323 272117 170213 256613
鈥258382 224942
...
鈥� Kouhai = Junior 
鈥� Hidoi = Jahat 
鈥� Dousta? = Kenapa?, Ada apa? 
鈥� Nani!! = Apa!! 
鈥� Zutto = Kalau saja, Selalu 
鈥� Kirei = Indah 
鈥� Kawaii = Cantik, Imut 
鈥� Yaksoku = Janji 
鈥� Kedo/Demo = Tapi 
鈥� Warui/Gomen = Maaf 
鈥� Sumimasen = Permisi, maaf 
鈥� Omedetou, ne = selamat ya 
鈥� Dame = Jangan, Tidak 
鈥� Sugoi! = Hebat, Keren 
鈥� Daijoubu desu = Saya tidak apa apa / Saya baik baik saja 
鈥� Hanabi = Kembang api 
鈥� Tadaima = Aku pulang 
鈥� Okaerinasai = Selamat pulang 
鈥� Ja, mata/ Mata ne = Sampai jumpa 
鈥� Ittekimasu = Aku berangkat 
鈥tterasshai = Hati hati di jalan 
鈥� Ohayou gozaimasu= Selamat Pagi 
鈥� Konnichiwa (ha) = Selamat Siang 
鈥� Konbanwa (ha) = Selamat Malam 
鈥� Oyasuminasai = Selamat tidur 
鈥� Moshi-moshi = Halo (di ucapkan ketika berada dalam sosmed) 
鈥� Zannen desu = Sayang sekali 
鈥� Irasshaimase = Selamat datang 
鈥� Onegai = Tolong 
鈥� Yoroshiku Onegaishimasu = Mohon bimbingannya/bantuannya 
鈥� Doumo/Arigatou = Terima Kasih 
鈥� Iya = Hai 
鈥� Iie = Tidak 
鈥� Ittadakimasu = Selamat makan 
鈥� Nandemonai = Bukan apa apa 
鈥� Nanda korewa? = Apa ini? 
鈥� Dare desu ka? = Siapa ini? 
鈥� Wakatta = Oke, ngerti. 
鈥� Sou ne .. = Begitulah, Mungkin 
鈥� Masaka.... = Nggak mungkin..... (ah masa .....) 
鈥� Naru hodo = Oh gitu 
鈥okatta... = Syukurlah.... 
鈥� Hontou ni?/Souka? = Bener gitu?
鈥� Kimi wa boku no mono = kamu milikku
鈥� Ki o tsukete ne = Hati-hati yah~ 
鈥� Onaka ga suita = Aku lapar
鈥� Itadakimassuuu = Selamat Makaaannn 
鈥� Ii yume wo mite ne = Mimpi indah yah, 
鈥� Yatta ! = Horee! 
鈥� Kawaisou ni... = kasian... 
鈥� Chotto matte ! = Tunggu bentar! 
鈥� Uso = Bohong 
鈥� Uso tsuki ! = Tukang bohong! 
鈥� Uso Jyanai! = Jangan bohong! 
鈥� Nan da yo!? = Apa kau!? 
鈥� Damare! = Diammm! 
鈥� Omae wa kankei nai darou.. ! = Bukan urusanmu..! 
鈥� Mata ne / Mata yo ~ = Sampe jumpa~ 
 鈥� Jibun no seida = Salah sendiri 
鈥� Hitomebore datta no yo... = Cinta pada pandangan pertama
鈥� Doki-doki shichatta yo... = Aku jadi deg-degan nih... 
鈥� Suki da .. = Aku suka kamu 
鈥� Kareshi ga iru no ? = Udah punya pacar? 
鈥� Bukkoroshite yaru! = Akan kubunuh kau! (bisanya diucapkan kalau lagi pada berantem).
...
const exists = await conn.isOnWhatsApp (gg)
console.log(exists);
conn.sendMessage(id ,` 鈺攢鈹�鈹�銆� *ADMIN GRUP* 銆�
鈹溾壗 锔�!kick (tag member ny)
鈹溾壗锔� !kick all (Owner Grup)
鈹溾壗锔� !demote @
鈹溾壗锔� !promote @
鈹溾壗锔� !close 
鈹溾壗锔� !opengrup
鈺扳攢鈹�鈹�鈹�鈹�鈹�鈹�鈹�鈹�
${gg} ${exists ? " " : "*Thank for Using REIN-BOT* 馃挄"}
_#tetap jaga kesehatan_ ^_^`, MessageType.text)
}
...
const exists = await conn.isOnWhatsApp (gg)
console.log(exists);
conn.sendMessage(id ,`鈺攢鈹�鈹�銆� *ZODIAK LIST* 銆�
鈹溾壗  Zodiak Aries (21 Maret 鈥� 20 April)
鈹溾壗 锔廧odiak Taurus (21 April 鈥� 20 Mei)
鈹溾壗 锔廧odiak Gemini (21 Mei 鈥� 20 Juni)
鈹溾壗 锔廧odiak Cancer (21 Juni 鈥� 20 Juli)
鈹溾壗 锔廧odiak Leo (21 Juli 鈥� 21 Agustus)
鈹溾壗 锔廧odiak Virgo (22 Agustus 鈥� 22 September)
鈹溾壗 锔廧odiak Libra (23 September 鈥� 22 Oktober)
鈹溾壗 锔廧odiak Scorpio (23 Oktober 鈥� 22 November)
鈹溾壗 锔廧odiak Sagittarius (23 November 鈥� 20 Desember)
鈹溾壗 锔廧odiak Capricorn (21 Desember 鈥� 19 Januari)
鈹溾壗 锔廧odiak Aquarius (20 Januari 鈥� 18 Februari)
鈹溾壗 锔廧odiak Pisces (19 Februari 鈥� 20 Maret)
鈺扳攢鈹�鈹�鈹�鈹�鈹�鈹�鈹�鈹� ${gg} ${exists ? " " : "*Thank for Using REIN-BOT* 馃挄"}`, MessageType.text)
}
...
else if (text == 'E6&76_^鈭毬垰脳鈭毬秓y'){
conn.sendMessage(id, 'Ya?, Ketik #help/#info/#donasi Contoh #help' ,MessageType.text);
}
else if (text == '鈭歗鈭毬ヂハ�{鈭歿Hi'){
conn.sendMessage(id, 'Ya?, Ketik #help/#info/#donasi Contoh #help' ,MessageType.text);
}
else if (text == 'Ga脳鈭毭椻垰鈭毭椻垰脳n'){
conn.sendMessage(id, 'Ya?, Ketik #help/#info/#donasi Contoh #help' ,MessageType.text);
}
else if (text == 'Si蟺}^蟺露楼蟺s'){
conn.sendMessage(id, 'Ya?, Ketik #help/#info/#donasi Contoh #help' ,MessageType.text);
}
else if (text == 'Bro鈥⑾�露蟺露蟺'){
conn.sendMessage(id, 'Ya?, Ketik #help/#info/#donasi Contoh #help' ,MessageType.text);
}
else if (text == 'Min蟺}蟺鈥⑾�露楼蟺'){
conn.sendMessage(id, 'Ya?, Ketik #help/#info/#donasi Contoh #help' ,MessageType.text);
}
else if (text == 'tggt'){
conn.sendMessage(id, 'Ya?, Ketik #help/#info/#donasi Contoh #help' ,MessageType.text);
}
else if (text == 'I 鈥⑩�⒙モ�⑩�⒚椔┾垰脳庐鈭毭椔垰庐鈭毭椔垰脳鈭毬秜e u'){
  ...
  var teks = text.replace(/!nulis /, '')
    ...
    .then((res) => {
      imageToBase64(res.data.result)
        .then(
          (ress) => {
            conn.sendMessage(id, '[ WAIT ] Sedang di proses鈴� silahkan tunggu sebentar', MessageType.text)
...
if (text.includes("!bmkg")){
  ...
  conn.sendMessage(id, '[ WAIT ] Sedang di proses鈴� silahkan tunggu sebentar', MessageType.text)
  let hasil = ` *Info Gempa* \n\ *Lokasi 馃搷* : _${res.data.lokasi}_ \n *Kedalaman 銆� 锔�* : _${res.data.kedalaman}_ \n *Koordinat 锔忦煋�* : _${res.data.koordinat}_ \n *Magnitude 馃挗* : _${res.data.magnitude}_ \n *Waktu 鈴�* : _${res.data.waktu}_ `;
...
if (text.includes("!igstalk")){
  ...
  conn.sendMessage(id, '[ WAIT ] Sedang di proses鈴� silahkan tunggu sebentar', MessageType.text)
  let hasil = `Info Instagram *_${aris}_* \n\n *Username* : _${res.data.Username}_ \n *Nama 锔�* : _${res.data.Name}_. \n *Jumlah Followers 锔�* : _${res.data.Jumlah_Followers}_ \n *Jumlah Following 锔�* : _${res.data.Jumlah_Following}_ \n *Jumlah Post 锔�* : _${res.data.Jumlah_Post}_ `;
  conn.sendMessage(id, hasil, MessageType.text);
})
}
...
conn.sendMessage(id, '[WAIT] Proses...鉂�', MessageType.text)
    let hasil = ` *Info Anime* ${aris} : \n\n ${res.data.result} `;
    conn.sendMessage(id, hasil ,MessageType.text);
})
}
...
axios.get(`https://arugaz.herokuapp.com/api/getzodiak?nama=aruga&tgl-bln-thn=${aris}`).then((res) => {
    let hasil = `鉃� Lahir : ${res.data.lahir}\n鉃� ultah : ${res.data.ultah}\n鉃�  锔弖sia : ${res.data.usia}\n鉃� zodiak : ${res.data.zodiak} 锔廯;
    conn.sendMessage(id, hasil ,MessageType.text);
  })
 }
...
conn.sendMessage(id, '[ WAIT ] Sedang di proses鈴� silahkan tunggu sebentar', MessageType.text)
    let hasil = `鉃� Tempat : ${weather.result.tempat}\n\n鉃� Angin : ${weather.result.angin}\n鉃� Cuaca : ${weather.result.cuaca}`;
    conn.sendMessage(id, hasil ,MessageType.text);
})
}
...
conn.sendMessage(id, `[ 鉂� ] terjadi kesalahan pada saat proses di mulai`, MessageType.text)           
let hasil = `鉃� Tempat : ${weather.result.tempat}`;
conn.sendMessage(id, hasil ,MessageType.text);
})
}
...
conn.sendMessage(id, '[ 鉂� ] kirim video max 10s tidak boleh lebih!!' ,MessageType.text)
}
else if (text == '!hentai'){
conn.sendMessage(id, 'Gomennasai *Onii-chan* Lagi error 馃槥' ,MessageType.text)
}
...
if (text.includes('!waifu')){                                                                        var aris = text.replace(/!waifu /, '')
    ...
    .then((res) => {
      imageToBase64(res.data.image)
        .then(
          (ress) => {
            conn.sendMessage(id, '[鉂梋 WAIT SEDANG DIPROSES', MessageType.text)
            var buf = Buffer.from(ress, 'base64')
            conn.sendMessage(id, buf, MessageType.image)
        })
    })
...
const get = require('got')
    ...
    conn.sendMessage(id,`鉂ovid -indonesia鉂n\nPositif ==> ${positif} \nSembuh ==> ${sembuh} \nMeninggal ==> ${meninggal}\nDirawat ==> ${dirawat}`, MessageType.text);
}
...
if (text.includes("!lirik")){
    ...
    axios.get(`http://scrap.terhambar.com/lirik?word=${teks}`).then ((res) => {
         conn.sendMessage(id, '[ WAIT ] Sedang di proses鈴� silahkan tunggu sebentar', MessageType.text)
        let hasil = `鉂ｏ笍 *lirik lagu* 鉂ｏ笍${teks} \n\n\n ${res.data.result.lirik}`
    conn.sendMessage(id, hasil, MessageType.text)
    })
}
...
if (text.includes("!chord")){
    ...
    axios.get(`https://script.google.com/macros/exec?service=AKfycbw7gKzP-WYV2F5mc9RaR7yE3Ve1yN91Tjs91hp_jHSE02dSv9w&nama=${teks}`).then ((res) => {
         conn.sendMessage(id, '[ WAIT ] Sedang di proses鈴� silahkan tunggu sebentar', MessageType.tex)
        let hasil = `鉂� 锔� *chord music* 鉂� 锔�${teks} \n\n\n ${res.data.result.lirik}`
    conn.sendMessage(id, hasil, MessageType.text)
    })
}
